...
class Star_Electric_Elementor {
	...
	private static function widgets(): array {
		return array(
			...
			'page-head'        => 'Star_Electric_Widget_Page_Head',
			'policy-panel'     => 'Star_Electric_Widget_Policy_Panel',
			'faq'              => 'Star_Electric_Widget_Faq',
			...
			'department-grid'  => 'Star_Electric_Widget_Department_Grid',
			'article-aside'    => 'Star_Electric_Widget_Article_Aside',
			'value-grid'       => 'Star_Electric_Widget_Value_Grid',
			'text-band'        => 'Star_Electric_Widget_Text_Band',
			'contact-form'     => 'Star_Electric_Widget_Contact_Form',
			'quote-form'       => 'Star_Electric_Widget_Quote_Form',
			'complaint-form'   => 'Star_Electric_Widget_Complaint_Form',
			'bulk-hero'        => 'Star_Electric_Widget_Bulk_Hero',
			'track-order'      => 'Star_Electric_Widget_Track_Order',
			'subcategory-sections' => 'Star_Electric_Widget_Subcategory_Sections',
			'brand-directory'  => 'Star_Electric_Widget_Brand_Directory',
			'brand-families'   => 'Star_Electric_Widget_Brand_Families',
			'promo-grid'       => 'Star_Electric_Widget_Promo_Grid',
			'deals-catalogue'  => 'Star_Electric_Widget_Deals_Catalogue',
			'deals-note'       => 'Star_Electric_Widget_Deals_Note',
			'archive-head'     => 'Star_Electric_Widget_Archive_Head',
			'archive-catalogue' => 'Star_Electric_Widget_Archive_Catalogue',
			'product-head' => 'Star_Electric_Widget_Product_Head',
			'product-gallery' => 'Star_Electric_Widget_Product_Gallery',
			'product-info' => 'Star_Electric_Widget_Product_Info',
			'product-purchase' => 'Star_Electric_Widget_Product_Purchase',
			'product-record' => 'Star_Electric_Widget_Product_Record',
			'product-content' => 'Star_Electric_Widget_Product_Content',
			'product-tabs' => 'Star_Electric_Widget_Product_Tabs',
			'product-related' => 'Star_Electric_Widget_Product_Related',
			'product-recent' => 'Star_Electric_Widget_Product_Recent',
			'woo-panel'        => 'Star_Electric_Widget_Woo_Panel',
			'wishlist'         => 'Star_Electric_Widget_Wishlist',
